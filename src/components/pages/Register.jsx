    ...
    return (
        ...
        >
            <label className='main-form__label' htmlFor='name'>
                Имя
                <input
                    className={`main-form__input ${errors.name ? 'main-form__input_error' : ''
                        }`}
                    name='name'
                    id='name'
                    type='text'
            ...
            <label className='main-form__label' htmlFor='email'>
                E-mail{' '}
                <input
                    className={`main-form__input ${errors.email ? 'main-form__input_error' : ''
                        }`}
                    name='email'
                    type='email'
                    id='email'
            ...
            <label className='main-form__label' htmlFor='password'>
                Пароль
                <input
                    className={`main-form__input ${errors.password ? 'main-form__input_error' : ''
                        }`}
                    name='password'
                    type='password'
                    id='password'
